...
extern void
RFM69_SetCSPin(bool);                         /// function to control the GPIO tied to RFM69 chip select (parameter HIGH or LOW)
...
extern void
Timeout_SetTimeout1(uint16_t);                /// function for timeout handling, sets a timeout, parameter is in milliseconds (ms)
